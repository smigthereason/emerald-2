...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen flex p-4 gap-4 overflow-hidden absolute inset-0">
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <button
                  className="w-10 h-10 flex items-center justify-center text-gray-400 hover:text-white bg-gray-50 rounded-lg hover:bg-[#D8798F] transition-colors"
        ...
        {/* Main Content */}
        <main className="flex-1 bg-white rounded-2xl shadow-sm p-6 max-h-[calc(100vh-120px)] overflow-y-auto">
          <Outlet />
        </main>
      </div>
    </div>
