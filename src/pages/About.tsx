    ...
    >
      ...
      <div className="relative w-full max-w-6xl h-[600px] mx-auto">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-4 font-beau">
      ...
      >
        ...
        {/* Right Text Section */}
        <div className="w-3/6 flex flex-col justify-center p-10 relative left-32">
      ...
      <div className="flex justify-center mt-12">
        <div className="border-b-2 border-black/40 w-60 -rotate-45 "></div>
      </div>
      ...
      >
        {/* left Text Section */}
        <div className="w-3/6 flex flex-col justify-center p-10 ">
          <h2 className="text-center text-2xl font-light mb-4">
          ...
          <ul className="relative list-disc list-inside mt-4 text-gray-700 text-left left-10">
            <li>
              <em>Unique Finds</em>
            </li>
            <li>
        ...
        {/* Right Image Section */}
        <div className="relative left-48 w-2/6 h-full rounded-lg overflow-hidden">
          <img
            className="w-full h-full object-cover "
      ...
      {/* Additional Section 3 */}
        ...
        <div
          className="relative w-full max-w-6xl h-[600px] mx-auto flex justify-center items-center"
          data-aos="fade-up"
          data-aos-delay="300"
        >
          <div className="w-3/6 flex flex-col justify-center items-center p-10 text-center">
            <h2 className="text-2xl font-light mb-4">
              <span className="text-black font-bold">Join the </span>Glow-Up
              Movement
            </h2>
            ...
            <p className="text-gray-600 mt-4 text-center">
              At Emerald Fashion, we’re not just selling clothes—we’re helping
              you transform your wardrobe and your confidence. Every purchase
              you make is a step toward a more sustainable future and a more
              stylish you.
              <br />
              <span className="font-bold relative top-10">
                Ready to glow up? Start thrifting today and discover the magic
                of Emerald Fashion!
              </span>
            </p>
          </div>
